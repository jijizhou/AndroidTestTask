...
import com.example.androidtesttask.base.ice.DefaultLceImpl
import com.example.androidtesttask.base.ice.ILce
import com.example.androidtesttask.utils.SmartUtils
import com.example.androidtesttask.utils.showToast

/**
 * 应用程序中所有Fragment的基类。
 */
abstract class BaseFragment : Fragment(), ILce, BaseFragmentInit, BackPressedListener {
    ...
    override fun onCreateView(
        ...
        params.setMargins(
            0,
            if (isHaveHeadMargin()) {
                SmartUtils().dp2px(if (isPort) 70f else 55f)
            } else 0,
            0,
            0
        )
